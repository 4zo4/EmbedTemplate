/**
 * @file common.c
 * @brief Common port-specific implementations for QEMU x86 Virt.
 * This file contains the implementations of the common functions for the QEMU x86 Virt.
 */
#include <assert.h>
#include <stdint.h>
#include <stdio.h>
